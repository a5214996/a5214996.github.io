...
function getOfflineEmbed() {
  return '<div id="o"><a href="https://discord.gg/8u7hYjwURE" target="_blank"><img src="/assets/discord.png"></a></div>';
}
...
function getPlayerEmbed(host, channel) {
  ...
  switch (host) {
    ...
    case "urlparam": {
      ...
      if (!slug) return '<div id="o" style="font-size:30px;color:#FFF">url parameter missing ?</div>';
