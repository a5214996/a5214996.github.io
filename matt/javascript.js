...
function GetPlayerEmbed(o, c) {
	...
	case 'ok':
		return '<iframe src=//ok.ru/videoembed/' + c + ' width=100% height=100% allow=autoplay resizable=true id=stream frameborder=0 scrolling=no allowtransparency=true allowfullscreen></iframe>';
	case 'jwplayer':
