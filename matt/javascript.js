...
function GetPlayerEmbed(o, c) {
	...
	case 'clappr':
		return `<div id="player"></div><script>var player = new Clappr.Player({source: "${c}", mute: true, autoPlay: true, poster: "https://i.imgur.com/RXEEHkO.png", plugins: [DashShakaPlayback], parentId: "#player", height: ${h}, width: "100%"});</script>`;
	case 'drive':
