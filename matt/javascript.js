...
function GetPlayerEmbed(o, c) {
	...
	case 'clappr':
		return `<div id="player"></div><script>var player = new Clappr.Player({source: "${c}", mute: true, autoPlay: true, poster: "https://i.imgur.com/RXEEHkO.png", plugins: [DashShakaPlayback, QualitySelector], qualitySelectorConfig: { title: 'Quality', labels: {
      5: '1080p, 4: '720p, 2: '480p, 1: '320p', 0: '160p', }, defaultQuality: 5, labelCallback: function(playbackLevel, customLabel) { return customLabel + playbackLevel.level.height + 'p';, }parentId: "#player", height: ${h}, width: "100%"});</script>`;
	case 'drive':
